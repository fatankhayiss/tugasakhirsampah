...
- **`Mobile/lib/core/constants/api_config.dart`**: Menyimpan URL server backend (`http://192.168.196.14/tugasakhirsampah/bank_sampah/`). Wajib diupdate jika pindah jaringan.
