...
- **Base URL**: `http://localhost/tugasakhirsampah/bank_sampah/` (or your local LAN IP such as `http://192.168.196.14/tugasakhirsampah/bank_sampah/` when testing on physical mobile devices).
...
2. Verify the backend IP address inside `lib/core/constants/api_config.dart`:
   ...
   static const String baseUrl = 'http://192.168.196.14/tugasakhirsampah/bank_sampah/';
   ```
