...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-xl mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">Tambah Penyetor Baru</h2>
        ...
        <form action="<?php echo BASE_URL; ?>index.php?page=penyetor/proses_simpan" method="POST" class="p-6">
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="alamat" name="alamat" rows="3" 
                              class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-sky-500 focus:border-sky-500" 
                              placeholder="Masukkan alamat penyetor"></textarea>
                </div>
            </div>
            ...
            <div class="mt-8 pt-5 border-t border-gray-200 flex justify-end gap-3">
                ...
                <button type="submit" name="simpan_penyetor" 
                    ...
                    <i class="fas fa-save mr-2"></i> Simpan Penyetor
                </button>
            </div>
        </form>
    </div>
